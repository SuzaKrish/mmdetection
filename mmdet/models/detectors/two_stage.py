...
from ..builder import DETECTORS, build_backbone, build_head, build_neck, build_attention
...
class TwoStageDetector(BaseDetector, RPNTestMixin):
    ...
    def simple_test_temp(self, img, img_metas, proposals=None, rescale=False, return_levels=True):
        """Test without augmentation."""
        assert self.with_bbox, 'Bbox head must be implemented.'
